...
class Main_Window(QWidget):
    def __init__(self, parent=None):
        ...
        [w, h] = [user32.GetSystemMetrics(0), user32.GetSystemMetrics(1)]# fit to all computers view
        self.title = 'Image Style Transfer'
        self.width = w
        self.height = h
        ...
        self.setWindowIcon(QIcon("logo/IconFinal.png"))
        ...
        pixmap = QPixmap("css/help2.png")
        #helpBtn.setStyleSheet("QPushButton {background: url(css/help2.png) no-repeat transparent;} ")
        Button_Icon = QIcon(pixmap)
        helpBtn.setIcon(Button_Icon)
        helpBtn.setIconSize(pixmap.rect().size())

        helpBtn.setFixedWidth(120)
        helpBtn.setFixedHeight(120)
        ...
        pixmap = QPixmap("logo/IconFinal.png")
        logo.setScaledContents(True)# fit the image to the lable
        ...
        # User button
        Btn1 = QtWidgets.QPushButton("convert image + style", self)
        Btn1.setObjectName("MainGuiButtons")
        Btn1.clicked.connect(self.open_transfer_window)
        self.secondsub_Layout.addWidget(Btn1)

        Btn2 = QtWidgets.QPushButton("convert 2 images + style", self)
        Btn2.setObjectName("MainGuiButtons")
        # userBtn.clicked.connect(self.openUserGui)
        self.secondsub_Layout.addWidget(Btn2)
        self.show()
    ...
    def open_transfer_window(self):
        userGui = Transfer_image(self)
        userGui.show()
        self.main_frame.setVisible(False)


class Transfer_image(QWidget):
    def __init__(self, parent=None):
        super(Transfer_image, self).__init__(parent)
        # init the initial parameters of this GUI
        user32 = ctypes.windll.user32
        user32.SetProcessDPIAware()
        ...
        # Creating main container-frame, parent it to QWindow
        self.main_frame = QtWidgets.QFrame(self)
        self.main_frame.setObjectName("MainF")
        self.main_frame.setFixedWidth(self.width)
        self.main_frame.setFixedHeight(self.height)
        self.main_layout = QtWidgets.QVBoxLayout(self.main_frame)
        ...
        self.firstsub_Frame = QtWidgets.QFrame(self.main_frame)
        self.firstsub_Frame.setFixedWidth(self.width)
        self.firstsub_Frame.setFixedHeight(100)
        self.main_layout.addWidget(self.firstsub_Frame)
        self.firstsub_Layout = QtWidgets.QHBoxLayout(self.firstsub_Frame)
        self.firstsub_Layout.setAlignment(Qt.AlignCenter)
        ...
        self.sub_Frame.setFixedHeight(800)

        self.main_layout.addWidget(self.sub_Frame)
        self.sub_Layout = QtWidgets.QHBoxLayout(self.sub_Frame)
        self.sub_Frame.setFixedWidth(self.width)
        ...
        generatebutton = QtWidgets.QPushButton("Generate", self)
