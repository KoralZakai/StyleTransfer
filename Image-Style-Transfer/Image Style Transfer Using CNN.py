...
class TransferImageGui(QWidget):
    ...
    def initUI2(self):
        ...
        self.contentframe.setGeometry(QtCore.QRect(self.width * 3.2 / 10, self.height * 1.7 / 7, 256, 256))
        ...
        self.styleframe.setGeometry(QtCore.QRect(self.width * 5.1 / 10, self.height * 1.7 / 7, 256, 256))
